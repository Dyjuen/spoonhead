...
class Game:
    ...
    def update_game_state(self):
        ...
        if self.game_state not in ['platformer', 'boss_fight', 'gacha_animation']:
        ...
        if self.game_state == 'platformer':
            ...
            if pygame.time.get_ticks() - self.gacha_animation_timer > 3000:
    ...
    def draw(self):
        ...
        if self.game_state == 'home_screen':
            ...
            if self.gacha_result:
                ...
                tier_color = WHITE
                if self.gacha_result['tier'] == 'Rare': tier_color = BLUE
                elif self.gacha_result['tier'] == 'Epic': tier_color = PURPLE
                elif self.gacha_result['tier'] == 'Legendary': tier_color = GOLD

                animation_time = pygame.time.get_ticks() - self.gacha_animation_timer
                scale_factor = min(1.0, animation_time / 1500)
